...
<template>
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-lg text-center lg:py-16 lg:px-6">
            <div v-if="our_team_header_status === 'success' && our_team_header_data?.data"
            ...
            <div v-if="our_team_members_status === 'success' && our_team_members_data?.data" class=" grid gap-8
                lg:gap-16 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div v-else class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3">
                <div v-for="_ in Array(3)" :key="_" class="text-center text-gray-500 dark:text-gray-400">
