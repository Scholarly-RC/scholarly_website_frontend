            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-lg">
                ...
                <div class="flex items-center lg:order-2 gap-2">
                    ...
                    <button type="button"
                        ...
                        <Icon name="heroicons:x-mark" class="hidden w-6 h-6" />
                    </button>
                </div>
                <div class="justify-between items-center w-full lg:flex lg:w-auto lg:order-1 relative"
                    ...
                    <ul
                        ...
                        <li>
                            <NuxtLink to="/engagements" class="block py-2 pr-4 pl-3 rounded lg:p-0"
                                :class="{ 'active-nav': route.name === 'engagements', 'inactive-nav': route.name !== 'engagements' }">
                                Engagements</NuxtLink>
                        </li>
                        <li>
