...
const {
	...
	status,
	error: _error,
} = useFetch(`${config.public.apiBaseUrl}/items/engagements_hero_section/`, {
	method: "get",
});
</script>
...
<template>
  <div class="mx-auto max-w-screen-lg py-16 px-4">
    <div
      v-if="status === 'pending'"
      class="mx-auto max-w-screen-lg text-center mb-8 lg:mb-12 animate-pulse"
    >
      <div
    ...
    >
      <div class="inline-block px-6 py-4 bg-black bg-opacity-50 rounded-3xl">
        ...
        <p class="mb-5 font-semibold text-white sm:text-xl">
