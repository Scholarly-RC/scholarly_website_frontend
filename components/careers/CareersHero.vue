...
const {
	...
	status,
	error: _error,
} = useFetch(`${config.public.apiBaseUrl}/items/careers_hero_section/`, {
	method: "get",
});
</script>
  ...
  <section class="bg-white dark:bg-gray-900">
    ...
    >
      <div class="mt-4 md:mt-0 mb-4 md:mb-0">
        <div
          class="mb-4 h-10 w-3/4 bg-gray-300 dark:bg-gray-700 rounded animate-pulse"
        ></div>
        <div
          class="mb-6 h-6 w-full bg-gray-200 dark:bg-gray-600 rounded animate-pulse"
        ></div>
        <div
          class="h-6 w-5/6 bg-gray-200 dark:bg-gray-600 rounded animate-pulse"
        ></div>
      </div>
      <div
        class="w-full h-64 bg-gray-300 dark:bg-gray-700 rounded-lg animate-pulse"
      ></div>
    </div>
    <div v-else>
      <div
